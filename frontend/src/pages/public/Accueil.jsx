...
import { Calendar, BookOpen, Heart, MapPin, Clock, ChevronRight, User, Play, FileText } from "lucide-react";
                ...
                <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 text-sm">{parametres.horaires || "Horaires communiqués prochainement"}</p>
                        </div>
                    </div>
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 text-sm">{adresseComplete || "Adresse communiquée prochainement"}</p>
                        </div>
                    </div>
                    <div className="flex items-start gap-4">
